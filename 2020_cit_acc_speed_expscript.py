...
def task_instructions( whichtext = ''):
    ...
    main_item_info = ' Kategorisieren Sie die folgenden Items als vertraut mit der ' + key_assignment + ' Taste: ' + ', '.join(the_targets).upper() + "\nKategorisieren Sie alle anderen Items als unvertraut mit der " + other_key + " Taste. (Diese andere Items sind: " + ', '.join(the_main_items).upper() + ". - Sie leugnen, irgendwelche der anderen Items als relevant für Sie wahrzunehmen, also kategorisieren Sie all diese mit der " + other_key + " Taste.)"
